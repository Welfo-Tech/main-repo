...
function StatusBadge({ label, tone }: { label: string; tone: "emerald" | "amber" | "blue" | "rose" | "violet" }) {
  const toneClasses = {
    ...
    amber: "bg-violet-50 text-violet-700 ring-violet-200",
    blue: "bg-slate-100 text-slate-700 ring-slate-200",
    rose: "bg-slate-100 text-slate-700 ring-slate-200",
...
function MetricCard({
  ...
  const toneClasses = {
    ...
    amber: "bg-violet-50 text-violet-700 ring-violet-100",
    blue: "bg-slate-100 text-slate-700 ring-slate-200",
    rose: "bg-slate-100 text-slate-700 ring-slate-200",
  ...
  return (
    <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
      ...
      <p className={`mt-3 text-sm ${tone === "emerald" ? "text-emerald-600" : tone === "amber" ? "text-violet-600" : tone === "blue" ? "text-slate-600" : tone === "rose" ? "text-slate-600" : "text-violet-600"}`}>
        {note}
      </p>
    </div>
  );
...
function ActionCard({
  ...
  const toneClasses = {
    emerald: "bg-emerald-50 text-emerald-700 group-hover:border-emerald-400",
    amber: "bg-violet-50 text-violet-700 group-hover:border-violet-400",
    blue: "bg-slate-100 text-slate-700 group-hover:border-slate-300",
    rose: "bg-slate-100 text-slate-700 group-hover:border-slate-300",
    violet: "bg-violet-50 text-violet-700 group-hover:border-violet-400",
  }[tone];

  return (
    <Link
      href={href}
      className="group rounded-2xl border border-slate-200 bg-white p-6 text-left shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg"
    >
  ...
  return (
    <AdminLayout>
      <div className="space-y-8">
        <section className="overflow-hidden rounded-3xl border border-emerald-100 bg-gradient-to-br from-white via-slate-50 to-violet-50 p-8 shadow-sm">
          <div className="flex flex-col gap-8 lg:flex-row lg:items-end lg:justify-between">
            <div className="max-w-2xl space-y-4">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <StatusBadge label="Customer Service" tone="blue" />
              </div>
            </div>
        ...
        <section className="rounded-3xl border border-slate-200 bg-gradient-to-r from-white via-slate-50 to-violet-50 p-6 shadow-sm">
          <div className="flex flex-col gap-6 lg:flex-row lg:items-center lg:justify-between">
            <div className="max-w-xl">
              <h2 className="text-xl font-semibold text-slate-950">Attention Required</h2>
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                ...
                <h3 className="mt-2 text-3xl font-semibold text-slate-900">3</h3>
              </div>
              <div className="rounded-2xl border border-violet-100 bg-white p-5 shadow-sm">
                <p className="text-sm text-slate-500">QC Failed</p>
                <h3 className="mt-2 text-3xl font-semibold text-violet-600">2</h3>
              </div>
              <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
                <p className="text-sm text-slate-500">Invoice Overdue</p>
                <h3 className="mt-2 text-3xl font-semibold text-slate-900">1</h3>
              </div>
            </div>
          </div>
        </section>
        ...
        <section>
          <div className="mb-5">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-950">Operational Overview</h2>
        ...
        <section>
          <div className="mb-5">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-950">Today's Snapshot</h2>
          ...
          <div className="grid gap-5 md:grid-cols-2 xl:grid-cols-4">
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">8</p>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">5</p>
              <p className="mt-2 text-sm text-emerald-600">Devices ready for dispatch</p>
            </div>

            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-2xl bg-violet-50 text-sm font-bold text-violet-700 ring-1 ring-violet-100">DP</div>
              <p className="text-sm text-slate-500">Dispatches</p>
              <p className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">3</p>
              <p className="mt-2 text-sm text-violet-600">Out for delivery</p>
            </div>
            ...
            <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm transition duration-300 hover:-translate-y-1 hover:shadow-lg">
              ...
              <p className="mt-3 text-4xl font-semibold tracking-tight text-slate-950">2</p>
        ...
        <section>
          <div className="mb-5">
            <h2 className="text-2xl font-semibold tracking-tight text-slate-950">Quick Actions</h2>
          ...
          <div className="grid gap-5 sm:grid-cols-2 xl:grid-cols-3">
            ...
            <ActionCard href="/organizations" title="Add Organization" description="Register a new customer organization." accent="OR" tone="violet" />
            <ActionCard href="/quotes" title="Create Quote" description="Generate a quotation for a repair or spare." accent="QT" tone="violet" />
        ...
        <section className="grid gap-6 xl:grid-cols-[1.2fr_0.8fr]">
          <div className="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="mb-5 flex items-center justify-between">
              <div>
                <h2 className="text-2xl font-semibold tracking-tight text-slate-950">Repair Pipeline</h2>
              ...
              {[
                ...
                <div key={stage.label} className="rounded-2xl border border-slate-100 bg-slate-50 p-4">
                  ...
                  <div className="mt-4 h-2 rounded-full bg-slate-200">
                    <div
                      className={`h-2 rounded-full ${stage.tone === "emerald" ? "bg-emerald-500" : stage.tone === "blue" ? "bg-slate-500" : "bg-violet-500"}`}
            ...
            <div className="space-y-4">
              {[
                ...
                <div key={item.title} className={`flex items-start gap-4 rounded-2xl border border-slate-100 p-4 ${index < 3 ? "border-b" : ""}`}>
                  <div className={`flex h-11 w-11 items-center justify-center rounded-2xl text-sm font-bold ring-1 ${item.tone === "emerald" ? "bg-emerald-50 text-emerald-700 ring-emerald-100" : item.tone === "blue" ? "bg-sky-50 text-sky-700 ring-sky-100" : item.tone === "violet" ? "bg-violet-50 text-violet-700 ring-violet-100" : "bg-amber-50 text-amber-700 ring-amber-100"}`}>
                    {item.accent}
                  </div>
